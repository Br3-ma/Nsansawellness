<html>
                ...
                <div class="row">
                    <div class="col-1">
                        <div style="padding:5px">
                            <div id="localVideoText" class="localVideoText"></div>
                            <video style="border: 1px solid white;" class="img-responsive" id='localVideo'>
                                
                                Your browser does not support the video tag.
                            </video>
                            <div id="remoteVideoText" class="remoteVideoText"></div>
                            <video style="border: 1px solid white;" height="300vh" width="100%" id='remoteVideo' class="img-responsive">
                                Your browser does not support the video tag.
                            </video>
                        </div>
    ...
    <script src='public/js/vix.js' type="module"></script>
  </body>
</html>