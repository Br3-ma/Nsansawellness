                    ...
                    <tr class="intro-x">
                        ...
                        <td class="table-report__action w-56">
                            <div class="flex justify-center items-center">
                                <a href="{{ route('patient-questionaires.edit', $q->id) }}" class="flex items-center mr-3"> <i data-lucide="check-square" class="w-4 h-4 mr-1"></i> Add Answers </a>
                                {{-- {!! Form::open(['method' => 'DELETE','route' => ['patient-questionaires.remove', $q->id, $q->questionaire_id],'style'=>'display:inline']) !!}
                            ...
                            <tr class="intro-x">
                                ...
                                <td class="w-4">
                                    {{-- {!! Form::open(['method' => 'DELETE','route' => ['patient-questionaires.remove', $ans->id, $q->questionaire_id],'style'=>'display:inline']) !!}
