                    ...
                    <tr class="intro-x">
                        ...
                        <td class="text-center">
                            ...
                            @else
                                ...
                                {{-- @else --}}
                                    @hasrole('admin')
                                    <a href="{{ route('bpb', ['id' => $bill->user_id])}}" class="flex items-center justify-center whitespace-nowrap text-danger"> <i data-lucide="wallet" class="w-4 h-4 mr-2"></i> Pay Now </a> 
                                    @else
